...
from cost_v9 import data, cost_v9
...
data = data.merge(cost_v9[['Name EN', 'Description EN', 'bonus 1 base value', 'bonus 1 max']], on='Name EN')

data_research = data[data['Type'] != 'Building'][['Name FR', 'Description EN', 'Type', 'Lifeform', 'bonus 1 base value', 'bonus 1 max']]
